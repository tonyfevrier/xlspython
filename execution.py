...
file = mpe.File('pour_analyse_cohorte_bis.xlsx',path = 'dataset_dulcinee/')
file.sauvegarde()
sheet = mpe.Sheet('pour_analyse_cohorte_bis.xlsx','que terminé',path = 'dataset_dulcinee/')
...
sheet.add_column_in_sheet_differently_sorted(3, 8,['dataset_après_moulinette_4(2).xlsx','consent vs nn consent  cohort',3,[74]])
